...
class TranslationService::GoogleTranslateV2 < TranslationService
  ...
  def transform_response(str, source_language)
    ...
    Translation.new(text: Sanitize.fragment(json.dig('data', 'translations', 0, 'translatedText'), Sanitize::Config::MASTODON_STRICT), detected_source_language: json.dig('data', 'translations', 0, 'detectedSourceLanguage') || source_language, provider: 'Google')
